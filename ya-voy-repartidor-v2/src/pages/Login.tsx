          ...
          <motion.div key="sel" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="w-full flex flex-col gap-3 mt-4">
              <button onClick={handleGoogle} disabled={loading}
                className="w-full bg-white font-bold py-4 rounded-2xl flex items-center justify-center gap-3 shadow-xl hover:opacity-90 transition-all disabled:opacity-60"
                style={{ color: ACCENT }}>
            ...
            {resetSent ? (
              <div className="flex flex-col gap-4">
                ...
                <button onClick={() => go("selection")}
                  className="w-full bg-white font-black py-4 rounded-2xl flex items-center justify-center shadow-xl hover:opacity-90 transition-all"
                  style={{ color: ACCENT }}>
                  Volver al inicio
                </button>
              </div>
