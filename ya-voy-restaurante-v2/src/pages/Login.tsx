          ...
          <motion.div key="sel" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}
            ...
            <div className="w-full flex flex-col gap-3 mt-4">
              <button onClick={handleGoogle}
                className="w-full bg-white text-orange-600 font-bold py-4 rounded-2xl flex items-center justify-center gap-3 shadow-xl hover:bg-orange-50 transition-all">
