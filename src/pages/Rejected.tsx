  ...
  return (
    <div className="min-h-screen bg-red-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <p className="text-sm text-slate-500 mb-5">Lamentamos informarte que tu solicitud no ha sido aprobada en este momento.</p>
        ...
        <div className="space-y-4">
          <p className="text-xs text-slate-400">
            Puedes apelar esta decisión o enviar una nueva solicitud después de corregir los datos.
          </p>
          ...
          <div className="flex flex-col gap-2">
            ...
            <a 
              href="mailto:2430936@upt.edu.mx"
